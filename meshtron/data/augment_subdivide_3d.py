...
def build_polytron_aug(r, rng, max_tri_points=768):
    ...
    import torch
    from meshtron.data.domain_extractor_3d import (to_cylindrical, subsample_points)
...
def _proc_one(p_str, n_vals, n3_maxblocks, max_tri_points):
    ...
    from meshtron.data.domain_extractor_3d import build_quadtron_sample, build_polytron_sample
    p = Path(p_str)
