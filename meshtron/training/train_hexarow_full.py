...
# PointEncoder, Block and GPTCond moved to gpt_cond.py so that loading a
# checkpoint no longer drags in the trainer. Re-exported here because
# generate.py, scripts/eval_family.py and others import them from this module.
from meshtron.model.gpt_cond import Block, GPTCond, PointEncoder  # noqa: E402,F401
